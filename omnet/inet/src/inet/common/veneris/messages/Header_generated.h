...
struct Header FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  VenerisMessageTypes type() const {
    return static_cast<VenerisMessageTypes>(GetField<uint32_t>(VT_TYPE, 0));
  }
  uint32_t size() const {
...
struct HeaderBuilder {
  ...
  void add_type(VenerisMessageTypes type) {
...
inline flatbuffers::Offset<Header> CreateHeader(
    ...
    VenerisMessageTypes type = VenerisMessageTypes_Reserved,
    uint32_t size = 0) {
