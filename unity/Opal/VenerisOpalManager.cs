...
namespace Opal
{
	public class VenerisOpalManager : OpalManager
	{
		...
		public override void SendMeshToGroup (int id, Transform t, Mesh mesh, MaterialEMProperties em)
		{
			Vector3[] v = mesh.vertices;
			int[] indices = mesh.triangles;
			Debug.Log ("Mesh Group:" + id + ". " + t.name + ".Triangle length=" + indices.Length);
