...
namespace Opal
{
	...
	public class OpalInterface {
		...
		[DllImport(dllName, CallingConvention = CallingConvention.Cdecl)]
		public static extern int Init ([In] float frequency, [In] bool useInternalTracing,  [In] bool holdReflections , [In] bool multiTransmitter);
		...
		[DllImport(dllName, CallingConvention = CallingConvention.Cdecl)]
		public static extern int AddTransmitter([In] int txId,[In] Vector3ToMarshal origin,   [In] Vector3ToMarshal polarization, [In] float transmitPower) ;
		[DllImport(dllName, CallingConvention = CallingConvention.Cdecl)]
		public static extern int RemoveTransmitter([In] int txId) ;
		[DllImport(dllName, CallingConvention = CallingConvention.Cdecl)]
		public static extern int AddTransmitterToGroup(int txId,float transmitPower, [In] Vector3ToMarshal origin,[In] Vector3ToMarshal polarization); 
		//extern "C" OPAL_API int AddTransmitterToGroup(int txId,float transmitPower, optix::float3 origin); 
		[DllImport(dllName, CallingConvention = CallingConvention.Cdecl)]
		public static extern int ClearGroup(); 
		[DllImport(dllName, CallingConvention = CallingConvention.Cdecl)]
		public static extern int GroupTransmit() ;
